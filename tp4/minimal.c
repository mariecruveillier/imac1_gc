...
void glGenTextures(GLsizei 1, GLuint* textures){
// 1 correspond au nombre de texture qu'on veut générer
...
int main(int argc, char** argv) {
	...
	SDL_Surface* tab_img[10];
	tab_img[0] = IMG_Load(filename);
	if(tab_img[0]==NULL){
